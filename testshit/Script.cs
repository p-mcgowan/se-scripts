...
// https://steamcommunity.com/app/244850/discussions/0/364040797992161734/
public void Main(string argument, UpdateType updateSource) {
    VRageMath.Vector3 origin = new VRageMath.Vector3(x1, y1, z1);
    VRageMath.Vector3 dest = new VRageMath.Vector3(x2, y2, z2);
    int radius = 1000;
    var dir = dest - origin;
    dir.Normalize();
    var target = dest - radius * dir;
}
