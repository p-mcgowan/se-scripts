...
public void Main(string argument, UpdateType updateSource) {
    foreach (KeyValuePair<string, DrawingSurface> drawable in graphics.drawables) {
        ...
        ds
            ...
            .Size(3f).Text("FAT BOI ")
            .SaveCursor()
            .Size(1f)
            .Text("right column").Newline(resetX: false)
            .Text("lorem").Newline(resetX: false)
            .Text("ipsum dolar").Newline(resetX: false)

            .Newline()
            .Size(0.1f).Text("lil tiny guy").Newline()
            .Size(1f).Text("back to normal")
